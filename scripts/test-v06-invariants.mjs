...
const checks = [
  ...
  ["token table starts closed to anon/auth", migration.includes("revoke all on private.plaid_access_tokens from public, anon, authenticated")],
  ["token vault is hardened by follow-on RLS migration", source.includes("plaid_tokens_household_access") && source.includes("security invoker")],
