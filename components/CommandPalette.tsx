...
const ITEMS: PaletteItem[] = [
  ...
  { label: "Refresh dividends & value", hint: "Portfolio", href: "/portfolio", keywords: "dividends yield income calendar value 52 week high analyst target refresh", icon: HandCoins, section: "Actions" },
