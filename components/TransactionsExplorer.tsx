        ...
        {filtered.map((transaction) => (
          <div className="table-row" key={transaction.id}>
            ...
            <strong className="transaction-description">
              ...
              {transaction.source === "plaid" ? <em className="source-badge plaid-test">PLAID TEST</em> : transaction.source === "file" ? <em className="source-badge file-import">FILE IMPORT</em> : transaction.source === "ofx_direct" ? <em className="source-badge direct-ofx">DIRECT OFX</em> : null}
            </strong>
